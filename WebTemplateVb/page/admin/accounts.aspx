...
<!--#include file ="plugins/sidebar/accounts_bar.aspx"-->
  ...
  <div class="container-fluid">
    ...
    <div class="content-wrapper">
      ...
      <div class="row">
        <div class="row">
          <div class="col-2">
            <a href="#" class="btn btn-info" data-toggle="modal" data-target="#new_account">Register Account</a>
          </div>
          <div class="col-2">
            <a href="#" class="btn btn-info" data-toggle="modal" data-target="#import_accounts">Import Account</a>
          </div>
          <div class="col-2">
            <a href="#" class="btn btn-info" onclick="export_employees()">Export Account</a>
          </div>
          <div class="col-2">
            <a href="#" class="btn btn-info" onclick="export_csv('accounts_table')">Export Account 2</a>
          </div>
          <div class="col-2">
...
<!--#include file ="plugins/js/accounts_script.aspx"-->