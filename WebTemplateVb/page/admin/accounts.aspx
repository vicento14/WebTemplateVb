...
<!--#include file ="plugins/sidebar/admin_bar.aspx"-->
        ...
        <div class="container-fluid">
                ...
                <div class="col-2">
                    <button class="btn btn-warning btn-block btn-file">
                        <form id="file_form" enctype="multipart/form-data">
                            <span class="mx-0 my-0" id="loading_indicator"><i class="fas fa-upload mr-2"></i>Import Account 2 </span>
                            <input type="file" id="file2" name="file" onchange="upload_csv()" accept=".csv">
                        </form>
                    </button>
                </div>
                <div class="col-2">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title col-12">JQUERY AJAX Load
                            </h3>
                        </div>
                        <!-- /.card-header -->
