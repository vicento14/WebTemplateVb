...
<!--#include file ="plugins/sidebar/table_switching_bar.aspx"-->
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="pagination.aspx">Home</a></li>
...
<!--#include file ="plugins/js/table_switching_script.aspx"-->
